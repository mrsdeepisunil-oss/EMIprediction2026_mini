...
#         csv_url = "https://github.com/mrsdeepisunil-oss/EMIprediction2026_mini/blob/main/EMI_Predict/emi_prediction_dataset.csv"
#         q2024 = pd.read_csv(csv_url, on_bad_lines='skip')
#         df = pd.read_csv(q2024)
